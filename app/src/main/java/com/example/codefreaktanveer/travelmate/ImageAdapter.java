...
/**
 * Created by Nipun on 20-Aug-16.
 */
public class ImageAdapter extends ArrayAdapter<ImageMoment> {
    private Context context;
    private ArrayList<ImageMoment> imageMoments;

    public ImageAdapter(Context context, ArrayList<ImageMoment> imageMoments) {
